...
export const UI_TRANSLATIONS: Readonly<Record<UiLanguage, Readonly<Record<string, string>>>> = {
  "pt-BR": {
    ...
    "properties.arrowStart": "Início",
    "properties.arrowEnd": "Fim",
    "edgeArrow.none": "Nenhuma",
    "edgeArrow.arrow": "Seta",
    "edgeArrow.arrowOpen": "Seta vazia",
    "edgeArrow.diamond": "Diamante",
    "edgeArrow.diamondOpen": "Diamante vazio",
    ...
    "cloud.title": "Descobrir arquitetura AWS",
    "cloud.subtitle": "Informe credenciais AWS read-only. Elas são usadas só para esta descoberta e nunca são armazenadas.",
    "cloud.close": "Fechar",
    "cloud.accessKeyId": "Access Key ID",
    "cloud.secretAccessKey": "Secret Access Key",
    "cloud.sessionToken": "Session Token (opcional, para credenciais temporárias)",
    "cloud.regions": "Regiões (separadas por vírgula)",
    "cloud.accountLabel": "Rótulo da conta (opcional)",
    "cloud.helpTitle": "Como criar credenciais seguras (least-privilege)",
    "cloud.helpStep1": "No IAM, crie um usuário dedicado (ou use credenciais temporárias via STS).",
    "cloud.helpStep2": "Anexe uma policy inline somente-leitura com as permissões abaixo (copie).",
    "cloud.helpStep3": "Gere um access key, cole aqui e apague/rotacione a chave depois de usar.",
    "cloud.copyPolicy": "Copiar policy IAM",
    "cloud.copied": "Policy copiada!",
    "cloud.securityNote": "Suas credenciais trafegam por HTTPS, são usadas de forma transitória no servidor apenas para ler os recursos e não são gravadas nem registradas em log.",
    "cloud.cancel": "Cancelar",
    "cloud.discover": "Descobrir",
    "cloud.discovering": "Descobrindo…",
    "cloud.errorMissingFields": "Informe Access Key ID, Secret Access Key e ao menos uma região.",
    "cloud.errorGeneric": "Não foi possível concluir a descoberta AWS."
  },
  "en-US": {
    "toolbar.new": "New",
    ...
    "properties.arrowStart": "Start",
    "properties.arrowEnd": "End",
    "edgeArrow.none": "None",
    "edgeArrow.arrow": "Arrow",
    "edgeArrow.arrowOpen": "Open arrow",
    "edgeArrow.diamond": "Diamond",
    "edgeArrow.diamondOpen": "Open diamond",
    ...
    "cloud.title": "Discover AWS architecture",
    "cloud.subtitle": "Provide read-only AWS credentials. They are used only for this discovery and are never stored.",
    "cloud.close": "Close",
    "cloud.accessKeyId": "Access Key ID",
    "cloud.secretAccessKey": "Secret Access Key",
    "cloud.sessionToken": "Session Token (optional, for temporary credentials)",
    "cloud.regions": "Regions (comma-separated)",
    "cloud.accountLabel": "Account label (optional)",
    "cloud.helpTitle": "How to create safe least-privilege credentials",
    "cloud.helpStep1": "In IAM, create a dedicated user (or use temporary STS credentials).",
    "cloud.helpStep2": "Attach a read-only inline policy with the permissions below (copy it).",
    "cloud.helpStep3": "Create an access key, paste it here, then delete/rotate the key afterwards.",
    "cloud.copyPolicy": "Copy IAM policy",
    "cloud.copied": "Policy copied!",
    "cloud.securityNote": "Your credentials travel over HTTPS, are used transiently on the server only to read resources, and are never stored or logged.",
    "cloud.cancel": "Cancel",
    "cloud.discover": "Discover",
    "cloud.discovering": "Discovering…",
    "cloud.errorMissingFields": "Provide Access Key ID, Secret Access Key and at least one region.",
    "cloud.errorGeneric": "Could not complete AWS discovery."
  }
};
