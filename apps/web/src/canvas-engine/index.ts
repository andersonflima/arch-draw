...
export type { RenderableEdge, RenderableEdgeLabel } from "./edge-render-model.js";
...
export { computeArrowHead, edgeArrowAnchors, sampleCubicBezier, type ArrowHead } from "./edge-canvas-geometry.js";
