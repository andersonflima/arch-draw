...
- Áreas de clique das portas de conexão calibradas para maior precisão, com distinção de gesto: saída na direção da porta inicia vínculo; gesto divergente inicia drag do elemento.
...
- Labels de âncoras exibidos em caixa horizontal fixa (sem seguir ângulo da linha e sem quebra de palavra), sem fundo visível e com recorte da linha atrás do texto.
...
- Suporte inicial de i18n com alternância rápida `PT/EN` na toolbar (PT-BR e EN-US para ações principais).
